    ...
    public partial class CreateSongUC : UserControl
    {
        ...
        private async void btnCreate_Click(object sender, EventArgs e)
        {
            if (CheckValidateValue())
            {
                ...
                song.Thumbnail = Constants.DOMAIN2 + "Assets/Images/" + randStr[0] + Path.GetFileName(song.Thumbnail);
                song.Lyric = Constants.DOMAIN2 + "Assets/Images/" + randStr[1] + Path.GetFileName(song.Lyric);
                song.URL = Constants.DOMAIN2 + "Assets/Images/" + randStr[2] + Path.GetFileName(song.URL);
